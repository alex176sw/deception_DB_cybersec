...
(DEFAULT, 'Bob', 'Brown', 'bob brown@example.com', '555-9012', 'IT', 'Engineer', '2022-02-01', 80000),
(DEFAULT, 'Alice', 'White', 'alice white@example.com', '555-1111', 'Human Resources', 'Manager', '2022-03-01', 60000),
(DEFAULT, 'Mike', 'Green', 'mikegreen@example.com', '555-2222', 'Finance', 'Director', '2022-04-01', 90000),
(DEFAULT, 'Samantha', 'Black', 'samanthablack@example.com', '555-3333', 'Legal', 'Counsel', '2022-05-01', 100000);
...
(DEFAULT, 'Project 2', '2022-04-01', '2022-06-30', 20000),
(DEFAULT, 'Project 3', '2022-07-01', '2022-09-30', 30000);
